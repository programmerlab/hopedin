  	...
  	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 right-content">
				<div class="main-right">
					<h4 class="chat-name">Profile Management <span style="float:right; margin-left:15px;"><a onclick="$('#profile_submit').trigger('click');" href="javascript:void(0);">Save <i class="fa fa-check"></i></a></span>
					 </h4>
					...
					<div class="public-profile genral-profile-acc signup-form">
					   <?php 
						if(isset($_SESSION['succ_msg'])){
							   ?>
							   <p class="alert alert-success text-center">Success! Profile Updated.</p>
							   <?php
							   unset($_SESSION['succ_msg']);
						   }
					    ?>
					   <form method="post" enctype="multipart/form-data" action="process/process.php?action=profile_uform" id="profile_uform" >
					   <button type="submit" id="profile_submit" style="display:none" >Save</button>
						<div class="upload-img text-center">
							<img id="blah" src="uploads/<?php echo $image; ?>">
							<p>Edit Photo <a onclick="$('#uploadss').click();" href="javascript:void(0);" ><i class="fa fa-edit"></i></a></p>
						</div>
					...
					<div class="field-login sign-input">
					<label>DOB</label>
			<input type="date" onchange="return getAge($(this).val());" required name="dob" value="<?php echo $row['dob']; ?>">
			<span class="input-icon"><i class="fa fa-calendar"></i></span>
		</div>
		<div class="field-login sign-input">
			<label>AGE</label>
			<input type="number" class="age_type" name="age" readonly required value="<?php echo $row['age']; ?>" >
		...
		<div class="field-login sign-input">
					...
					<select required name="language" >
						...
						<option <?php if($row['language']=='English') echo "selected"; ?> value="English" >English</option>
						<option <?php if($row['language']=='Chinese') echo "selected"; ?> value="Chinese">Chinese</option>
					</select>
					...
					<select name="currency" required >
						...
						<option <?php if($row['currency']=='rmb') echo "selected"; ?> value="rmb">RMB</option>
						<option <?php if($row['currency']=='pkr') echo "selected"; ?> value="pkr">PKR</option>
						<option <?php if($row['currency']=='inr') echo "selected"; ?> value="inr" >INR</option>
					</select>
