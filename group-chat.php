		...
		<div class="row">
			<div class="col-sm-3 side-menu">
				...
				<ul class="side-menu-list">
					...
					<li class="chat-selected"><a href="#"><span class="menu-icon"><i class="fa fa-users"></i></span> Group Chat</a> <span class="right-ico"><i class="fa fa-angle-right"></i></span></li>
			...
			<div class="col-sm-9 right-content">
				<div class="main-right">
					<h4 class="chat-name">Group Chat <span class="pull-right"><i class="fa fa-plus"></i></span></h4>
								...
								<div class="panel panel-default">
								  <div class="panel-heading">
									<h4 class="panel-title">
									  <a href="#"><i class="fa fa-users" style="float:left; margin-top:3px; margin-right:15px;"></i>Group 1<span> <span class="time">group id</span> <i class="fa fa-angle-right"></i></span>
									   </a>
									</h4>
								  </div>
